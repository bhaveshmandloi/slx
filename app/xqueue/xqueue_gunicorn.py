...
source: https://github.com/edx/configuration/blob/open-release/maple.2/playbooks/roles/xqueue/templates/xqueue_gunicorn.py.j2
...
timeout = 300
bind = "127.0.0.1:8040"
pythonpath = "/opt/bitnami/edx/app/xqueue/xqueue"
...
workers = int((multiprocessing.cpu_count()-1) / 2) + 1
